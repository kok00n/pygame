...
class FpsView(object):
    ...
    def run(self):
        ...
        while mainloop:
            ...
            # self.draw_pentagram(where=((self.width - radius) // 2,
            #                            (self.height - radius) // 2), radius=int(radius / 2))
    ...
    def draw_pentagram(self, where, radius=200, color=(0, 180, 0)):
        surface = pygame.Surface((radius * 2, radius * 2))
        ...
        pygame.draw.polygon(surface, color, (a3, a4, a6), 4)
        pygame.draw.polygon(surface, color, (a4, a5, a7), 4)
        pygame.draw.polygon(surface, color, (a5, a1, a8), 4)
